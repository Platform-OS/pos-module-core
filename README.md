...
You can choose to create new hooks either on your modules or inside your `app` folder, you can collect them into folders for example `app/views/partials/hooks/hook_permission.liquid` or  `modules/your-module/public/views/partials/lib/hooks/hook_permission.liquid`.
...
```
This function will return with the created variable's value.
